...
# Bot information
API_ID = environ.get('API_ID', '25895175')
if len(API_ID) == 0:
...
PICS = (environ.get('PICS', 'https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg https://iili.io/3eWtG44.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '1728951776')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002248710429').split()]
if len(INDEX_CHANNELS) == 0:
    logger.info('INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002566713244')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001546408594')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://gogogaming7428:aLmlRWaqhL9c0SuR@cluster0.bk0fzz3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+BSkLj7TCrZ1kYjZl')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/+BSkLj7TCrZ1kYjZl')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+BSkLj7TCrZ1kYjZl')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+BSkLj7TCrZ1kYjZl")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/+BSkLj7TCrZ1kYjZl")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "dc80d904624be1afd9276ebae41435aa4d1624a6")
...
# for Premium 
PRE_DAY_AMOUNT = int(environ.get('PRE_DAY_AMOUNT', '50')) # add amount in INR for premium charge pre day 
UPI_ID = environ.get("UPI_ID", "killerxvip@ybl")
if len(UPI_ID) == 0:
    logger.error('UPI_ID is missing, exiting now')
    exit()
UPI_NAME = environ.get("UPI_NAME", "Mahender") # add your UPI account name
if len(UPI_NAME) == 0:
    logger.error('UPI_NAME is missing, exiting now')
    exit()
RECEIPT_SEND_USERNAME = environ.get("RECEIPT_SEND_USERNAME", "@KILLERxVIPP")
